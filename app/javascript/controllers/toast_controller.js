...
export default class extends Controller {
  ...
  createContainer() {
    ...
    container.className = 'fixed top-4 right-4 z-50 space-y-2 pointer-events-none max-w-sm'
      ...
      <div class="p-4 ${config.bgColor}">
        <div class="flex items-start">
          ...
          <div class="ml-4 flex-shrink-0">
            <button class="inline-flex rounded-md ${config.bgColor} text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-${config.color}-50 focus:ring-${config.color}-600" 
